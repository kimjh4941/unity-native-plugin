...
namespace JonghyunKim.NativeToolkit.Tests
{
    ...
    /// </summary>
    public sealed class MacShareSampleSceneWiringTests
    {
        private const string ShareUxmlPath = "Packages/com.jonghyunkim.nativetoolkit/Runtime/Resources/UI/macOS/Share/MacShareManagerExample.uxml";
        private const string ShareUssPath = "Packages/com.jonghyunkim.nativetoolkit/Runtime/Resources/UI/macOS/Share/MacShareManagerExampleStyle.uss";
        private const string TopMenuUxmlPath = "Packages/com.jonghyunkim.nativetoolkit/Runtime/Resources/UI/Top/TopMenuExample.uxml";

        private const string ShareResourcesUxmlPath = "UI/macOS/Share/MacShareManagerExample";
        private const string ShareResourcesUssPath = "UI/macOS/Share/MacShareManagerExampleStyle";
        ...
        private static readonly string[] RequiredShareButtonNames =
        {
            ...
            "ShareImagesButton",
            "ShareFilesButton",
            "ShareTextAndUrlButton",
            "ShareExcludingServicesButton",
            "ShareViaMailButton",
            "ShareEmptyButton",
            "ShareInvalidUrlButton",
            "ShareMissingFileButton",
            "ShareMissingImageButton",
            "ShareUnknownServiceButton"
        };
        ...
        public void ShareUxml_ContainsAllRequiredButtons()
        {
            ...
            foreach (string name in RequiredShareButtonNames)
            {
                ...
                Assert.IsNotNull(button, $"Button '{name}' not found in MacShareManagerExample.uxml");
            }
        }
        ...
        public void ShareUxml_ContainsAllRequiredLabels()
        {
            ...
            foreach (string name in RequiredShareLabelNames)
            {
                ...
                Assert.IsNotNull(label, $"Label '{name}' not found in MacShareManagerExample.uxml");
            }
        }
