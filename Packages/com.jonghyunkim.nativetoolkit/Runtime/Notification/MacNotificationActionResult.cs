...
{
    /// <summary>
    /// Represents data delivered when a notification action button is tapped on macOS.
    /// </summary>
    public readonly struct MacNotificationActionResult
    {
        ...
        internal MacNotificationActionResult(string notificationId, string actionId, string? userInfoJson)
        {
