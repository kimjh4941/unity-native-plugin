...
| [windows-c-abi-2](topics/windows-c-abi-2/README.md) | 移行 | 企画中 | 2026-09-26 | Windows の C ABI が 1.x から 2.0.0 に置き換わる。P/Invoke 47 本と JSON 依存層の書き直し。native-toolkit のマージ待ち |
