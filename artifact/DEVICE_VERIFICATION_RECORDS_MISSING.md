# iOS / Android の実機確認記録が無い

- 記録日: 2026-09-10
- 分類: 横断課題（clipboard の iOS / Android。他機能も同様の可能性）
...
- 進捗: 該当 6 文書に訂正の注記を入れただけ。**詳細記録は未作成**
...
clipboard 以外（notification / share / dialog）でも同じずれがある可能性がある。
**未確認。** 実機スクリーンショットの有無と本文の記述を突き合わせれば機械的に洗い出せる。
