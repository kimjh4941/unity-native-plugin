...
| 実機動作確認 | **2026-09-09 に実施済み**（本工程の範囲外だったもの）。結果は `artifact/results/clipboard/2026-09-09-windows-clipboard-verify-manual-result-v1.md` |
...
> **未実施項目の最新は `artifact/results/clipboard/2026-09-09-windows-clipboard-verify-manual-result-v1.md` の 6 節。**
...
**以降の残件は `artifact/results/clipboard/2026-09-09-windows-clipboard-verify-manual-result-v1.md` の 6 節にある。**
