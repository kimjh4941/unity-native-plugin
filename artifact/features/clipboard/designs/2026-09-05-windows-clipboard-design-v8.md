...
- レビュー: `artifact/features/clipboard/reviews/2026-09-05-windows-clipboard-design-review-v4.md`（A1 1 種類 + B 2 件 + C 3 件を v7 で反映。サーキットブレーカー適用）
- レビュー: `artifact/features/clipboard/reviews/2026-09-05-windows-clipboard-design-review-v5.md`（**別モデルによる独立レビュー**。A1 1 種類 + B 2 件 + C 3 件を本版で反映）
