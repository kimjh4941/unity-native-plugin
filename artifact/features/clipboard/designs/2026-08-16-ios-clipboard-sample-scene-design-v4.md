...
- 前版: `artifact/features/clipboard/designs/2026-08-16-ios-clipboard-sample-scene-design-v3.md`
- 対象レビュー: `artifact/features/clipboard/reviews/2026-08-16-ios-clipboard-sample-scene-design-review-v3.md`（総合評価「要修正（高優先度なし）」）
