...
> 痕跡として `manual/1.10.0/images/android/clipboard/` の実機スクリーンショットがある。
...
- 対象プラットフォーム: Android
- ブランチ: feature/UNT-8
- 実装計画: `artifact/features/clipboard/designs/2026-07-26-android-clipboard-design-v4.md`（review-document で3回レビュー済み、承認水準）
- 対象レビュー: `artifact/features/clipboard/reviews/2026-07-26-android-clipboard-implementation-feature-review-v1.md`, `artifact/features/clipboard/reviews/2026-07-26-android-clipboard-implementation-feature-review-v2.md`

### v2 からの変更点（レビュー反映）

対象: `artifact/features/clipboard/reviews/2026-07-26-android-clipboard-implementation-feature-review-v2.md`（high 指摘なし、v1 の `InvokeInOrder` 問題は解消済みと確認された）
