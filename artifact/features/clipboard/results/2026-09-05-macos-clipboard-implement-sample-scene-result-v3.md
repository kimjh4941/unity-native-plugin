...
- サンプル計画: `artifact/features/clipboard/designs/2026-09-05-macos-clipboard-sample-scene-design-v3.md`
- 参照する実装計画: `artifact/features/clipboard/designs/2026-09-03-macos-clipboard-design-v13.md`（以降 `v13`）
- 前版: `2026-09-05-macos-clipboard-implement-sample-scene-result-v2.md`
- 反映したレビュー: `artifact/features/clipboard/reviews/2026-09-05-macos-clipboard-implement-sample-scene-review-v2.md`（**Codex。2 巡目。要修正（重大）**。A 区分 2 / B 区分 1 / medium 2）
