...
- 手順: `artifact/features/clipboard/designs/2026-09-08-windows-clipboard-sample-scene-design-v3.md` 6 節・9 節
- 判定基準: `artifact/features/clipboard/designs/2026-09-05-windows-clipboard-design-v8.md` 9.3（M-1 〜 M-24）
- サンプル実装: `artifact/features/clipboard/results/2026-09-08-windows-clipboard-implement-sample-scene-result-v3.md`
- ログ: `artifact/features/clipboard/results/logs/2026-09-09-windows-clipboard-verify-manual-session1.log`
...
（`artifact/topics/device-verification-records/README.md`）。
