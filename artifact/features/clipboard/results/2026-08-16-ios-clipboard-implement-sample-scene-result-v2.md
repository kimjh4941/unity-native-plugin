...
- 機能名: clipboard
- 対象プラットフォーム: iOS
- 計画ファイル: `artifact/features/clipboard/designs/2026-08-16-ios-clipboard-sample-scene-design-v5.md`（承認済み）
- 前版: `artifact/features/clipboard/results/2026-08-16-ios-clipboard-implement-sample-scene-result-v1.md`
- 対象レビュー: `artifact/features/clipboard/reviews/2026-08-16-ios-clipboard-implement-sample-scene-review-v1.md`（総合評価「要修正（軽微）」）
