...
- 対象プラットフォーム: macOS
- ブランチ: `feature/UNT-10`
- 実装計画: `artifact/features/clipboard/designs/2026-09-03-macos-clipboard-design-v11.md`
- **対象範囲: 段 3（3a = 残り 8 操作 / 3b = 監視一式）**
- 前版: `2026-09-03-macos-clipboard-implementation-feature-result-v3.md`（段 2）
- 反映したレビュー: `artifact/features/clipboard/reviews/2026-09-03-macos-clipboard-design-review-v8.md`（Codex）
