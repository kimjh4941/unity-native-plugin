...
- 実装結果: `artifact/features/clipboard/results/2026-09-07-windows-clipboard-implementation-feature-result-v4.md`
- 前回レビュー: `artifact/features/clipboard/reviews/2026-09-07-windows-clipboard-implementation-feature-review-v1.md`（**ステップ 1 の純粋層のみが対象**）
...
`artifact/topics/os-prefix-violations/README.md` への新規追加は不要。
