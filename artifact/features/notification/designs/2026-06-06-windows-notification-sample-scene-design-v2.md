...
- 対象プラットフォーム: Windows
- ブランチ: feature/UNT-4
- 実装結果ファイル: artifact/features/notification/results/2026-06-06-windows-notification-implementation-feature-result-v1.md
- レビュー: artifact/features/notification/reviews/2026-06-06-windows-notification-sample-scene-design-review.md（v1 → v2 改善点を反映）
