...
- 対象プラットフォーム: macOS
- 実装計画: artifact/features/notification/plans/2026-05-16-macos-notification-implementation-plan-v2.md
- 実装結果: artifact/features/notification/results/2026-05-16-macos-notification-implementation-result-v1.md
