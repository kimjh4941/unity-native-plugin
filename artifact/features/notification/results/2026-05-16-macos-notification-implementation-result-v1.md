...
> 痕跡として `manual/1.10.0/images/mac/notification/` に、
> サンプル画面を実機で撮った `Example_*` のスクリーンショットが 8 枚ある。
...
- 対象プラットフォーム: macOS
- ブランチ: feature/UNT-3
- 実装計画書: artifact/features/notification/plans/2026-05-16-macos-notification-implementation-plan-v2.md
