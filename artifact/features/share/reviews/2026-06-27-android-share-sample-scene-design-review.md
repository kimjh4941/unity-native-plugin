...
- 日付: 2026-06-27
- 対象ファイル: `/Users/jonghyunkim/Desktop/unity-native-plugin/artifact/features/share/designs/2026-06-27-android-share-sample-scene-design-v2.md`
- 機能名: share
- 対象 OS: Android
...
1. セクション 0 / 1.1 / 1.4
   - 問題: 本設計は chooser action callback 実装を「実装完了」として扱っているが、`artifact/features/share/reviews/2026-06-27-android-share-implementation-feature-review-v1.md` では `ShareChooserActionCallbackCoordinator.Fire` の例外継続契約に重大な実装バグがあり、総合評価は「要修正（重大）」になっている。
