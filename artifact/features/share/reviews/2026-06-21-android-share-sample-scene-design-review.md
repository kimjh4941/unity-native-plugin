...
- 日付: 2026-06-21
- 対象ファイル: `artifact/features/share/designs/2026-06-21-android-share-sample-scene-design-v1.md`
- 機能名: share
- プラットフォーム: Android
...
- 改善提案: `artifact/features/share/reviews/2026-06-21-android-share-implementation-feature-review-v1.md` を前提資料に追加し、次をサンプル実装開始条件として明記する。
