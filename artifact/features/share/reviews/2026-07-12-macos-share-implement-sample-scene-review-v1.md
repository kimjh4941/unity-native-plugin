...
- サンプルシーン計画: `artifact/features/share/designs/2026-07-12-macos-share-sample-scene-design-v1.md`
- サンプルシーン実装結果: `artifact/features/share/results/2026-07-12-macos-share-implement-sample-scene-result-v1.md`
- 対象プラットフォーム: macOS
- 機能名: share
