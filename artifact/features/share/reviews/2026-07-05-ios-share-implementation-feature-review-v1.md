...
- PR番号: なし
- diff: `develop...HEAD`
- 実装計画: `artifact/features/share/designs/2026-07-05-ios-share-design-v5.md`
- 実装結果: `artifact/features/share/results/2026-07-05-ios-share-implementation-feature-result-v1.md`
- 対象プラットフォーム: iOS
...
2. Manager 経由の即時 Failure / dispatcher 経路が未テストのまま残っている。
   ...
   - 関連: `artifact/features/share/designs/2026-07-05-ios-share-design-v5.md:501`
   - 関連: `artifact/features/share/results/2026-07-05-ios-share-implementation-feature-result-v1.md:143`
...
1. 実装結果に記載された Unity Test Runner の出力ファイルを現在の working tree で確認できなかった。
   - 対象: `artifact/features/share/results/2026-07-05-ios-share-implementation-feature-result-v1.md:88`
