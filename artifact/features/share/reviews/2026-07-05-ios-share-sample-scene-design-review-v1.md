...
- 日付: 2026-07-05
- 対象ファイル: `artifact/features/share/designs/2026-07-05-ios-share-sample-scene-design-v1.md`
- 機能名: share
- プラットフォーム: ios
...
1. Editor で iOS Share サンプルを確認する方針と、Editor では Android Share に遷移する暫定方針が矛盾している。
   - 対象: `artifact/features/share/designs/2026-07-05-ios-share-sample-scene-design-v1.md:184`
   - 関連: `artifact/features/share/designs/2026-07-05-ios-share-sample-scene-design-v1.md:282`
   - 関連: `artifact/features/share/designs/2026-07-05-ios-share-sample-scene-design-v1.md:314`
...
1. `excludedActivityTypes` の手動確認で Facebook を主な合否条件にしない方が安定する。
   - 対象: `artifact/features/share/designs/2026-07-05-ios-share-sample-scene-design-v1.md:219`
   - 関連: `artifact/features/share/designs/2026-07-05-ios-share-sample-scene-design-v1.md:309`
