...
- 機能名: share
- 対象プラットフォーム: macOS
- 参照計画書: `artifact/features/share/designs/2026-07-12-macos-share-sample-scene-design-v1.md`（レビュー `artifact/features/share/reviews/2026-07-12-macos-share-sample-scene-design-review-v1.md` で「LGTM、残件なし」として承認済み）
