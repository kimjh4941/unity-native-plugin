...
- 対象プラットフォーム: macOS
- ブランチ: feature/UNT-7
- 参照計画書: `artifact/features/share/designs/2026-07-12-macos-share-design-v3.md`（レビュー `artifact/features/share/reviews/2026-07-12-macos-share-design-review-v3.md` で残件なしとして承認済み）
